...
import { brands, formatDate } from "@/lib/data";
  ...
  return (
    <div>
      ...
      <ul className="mt-6 space-y-3">
        {items.length === 0 && <li className="rounded-2xl border border-dashed border-neutral-300 bg-white p-8 text-center text-sm text-neutral-500">Follow a brand to receive notifications.</li>}
        {items.map((n) => {
